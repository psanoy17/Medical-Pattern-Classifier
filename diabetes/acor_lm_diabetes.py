"""
ACOR-LM with Multiple Colonies for Diabetes Classification - 4-Fold Cross-Validation
...
# Import baseline ACOR from acor_diabetes.py
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from acor_diabetes import SOCHA_ACOR, FNN, objective_function as baseline_objective_function
...
if __name__ == "__main__":
    print("Diabetes Classification - Baseline ACOR vs Hybrid ACOR-LM")
    ...
    with open(os.path.join(output_dir, 'diabetes_kfold_comparison_results.txt'), 'w') as f:
        f.write("Diabetes Classification - Baseline ACOR vs Hybrid ACOR-LM\n")
    ...
    print(f"\nResults saved to: diabetes_kfold_comparison_results.txt")
    ...
    ax.set_ylabel('Score')
    ax.set_title('Diabetes Classification - Baseline ACOR vs Hybrid ACOR-LM\n(4-fold CV, 50 runs/fold)')
    ax.set_xticks(x)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'diabetes_kfold_comparison.png'), dpi=300, bbox_inches='tight')
    plt.show()
    
    print("Comparison plot saved to: diabetes_kfold_comparison.png")