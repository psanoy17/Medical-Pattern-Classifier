...
if __name__ == "__main__":
    ...
    with open(os.path.join(output_dir, 'diabetes_acor_lm_model.pkl'), 'wb') as f:
        pickle.dump(model_data, f)
    
    print(f"\nModel saved to: diabetes_acor_lm_model.pkl")
    ...
    plt.ylim(0, 1)
    plt.title('ACOR-LM with Multiple Colonies - Diabetes (8 features)')
    plt.ylabel('Score')
