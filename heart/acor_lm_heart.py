...
if __name__ == "__main__":
    ...
    with open(os.path.join(output_dir, 'heart_acor_lm_results.pkl'), 'wb') as f:
        pickle.dump(results_data, f)
    
    print(f"\nResults saved to: {os.path.join(output_dir, 'heart_acor_lm_results.pkl')}")
    ...
    plt.ylim(0, 1)
    plt.title('ACOR-LM with Multiple Colonies - Heart Disease Classification Performance')
    plt.ylabel('Score')
