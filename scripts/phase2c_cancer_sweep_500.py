"""
Phase 2C: 500-Config Random Sweep on Cancer Dataset
...
def main():
    parser = argparse.ArgumentParser(description='500-config random sweep on cancer')
    ...
    parser.add_argument('--output', type=str, default='scripts/phase2c_cancer_sweep_500.csv', help='Output CSV')
    ...
    print(f"Loaded cancer: {X.shape[0]} samples, {X.shape[1]} features")
