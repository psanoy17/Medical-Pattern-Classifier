"""
Phase 2C: 100-Config Random Sweep on Diabetes Dataset
Quick validation to compare parameter sensitivity across datasets.
"""
...
def main():
    parser = argparse.ArgumentParser(description='100-config random sweep on diabetes')
    parser.add_argument('--n-configs', type=int, default=100, help='Number of configs to sample')
    parser.add_argument('--n-runs', type=int, default=2, help='Runs per config')
    parser.add_argument('--seed', type=int, default=42, help='Random seed')
    parser.add_argument('--output', type=str, default='scripts/phase2c_diabetes_sweep_100.csv', help='Output CSV')
