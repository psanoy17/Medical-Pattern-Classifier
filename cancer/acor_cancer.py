...
# --------------------------------------------------
class SOCHA_ACOR:
    def __init__(self, obj_func, dim, n_ants=2, n_samples=148, q=0.95, xi=0.98, max_iter=100, patience=15, seed=42):
...
if __name__ == "__main__":
    print("ACOR for Cancer Classification")
    print("=" * 60)
    ...
    with open(os.path.join(output_dir, 'cancer_acor_results.txt'), 'w') as f:
        f.write("Cancer Classification - ACOR (9 Features)\n")
        f.write("=" * 60 + "\n")
    ...
    plt.ylim(0, 1)
    plt.title('ACOR - Cancer Classification (9 features, 50 runs)')
    plt.ylabel('Score')
    ...
    print("Performance plot saved to: cancer_acor_performance.png")